...
export function ToggleTheme() {
  ...
  return (
    <button
      ...
      className="relative z-10 rounded-full bg-white p-1.5 shadow-lg ring-1 ring-gray-900/5 hover:ring-gray-800/20 dark:border-gray-700 dark:bg-gray-800 dark:hover:ring-gray-700 md:p-2"
